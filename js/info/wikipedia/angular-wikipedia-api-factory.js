...
angular
  .module("jtt_wikipedia", [])
  .factory("wikipediaFactory", [
    "$http",
    "wikipediaSearchDataService",
    function($http, wikipediaSearchDataService) {
      var wikipediaFactory = {};

      wikipediaFactory.searchArticlesByTitle = function(_params) {
        var wikipediaSearchData = wikipediaSearchDataService.getNew(
          "searchArticlesByTitle",
          _params
        );

        return $http.jsonp(wikipediaSearchData.url, {
          method: "GET",
    ...
    this.getNew = function(_type, _params) {
      ...
      switch (_type) {
        case "searchArticlesByTitle":
          ...
          wikipediaSearchData.object.explaintext = "";

          wikipediaSearchData = this.fillDataInObjectByList(
            wikipediaSearchData,
            _params,
            [
              "prop",
